...
incomplete_piece_test() ->
    ...
    {ok, {I1, BlockSize, empty}} = ahoy_piece:pop_missing_block(Pid),
    {ok, {I2, BlockSize, empty}} = ahoy_piece:pop_missing_block(Pid),
    ahoy_piece:add_completed_block(Pid, {I1, BlockSize, BlockData}),
    ahoy_piece:add_completed_block(Pid, {I2, BlockSize, BlockData}),
    ahoy_piece:add_completed_block(Pid, {I2 + 1, BlockSize, BlockData}),
    ahoy_piece:add_completed_block(Pid, {I2 + 2, BlockSize, BlockData}),
    ?assertEqual(false, ahoy_piece:raw_piece(Pid)).
...
completed_piece_test() ->
    ...
    ahoy_piece:add_completed_block(Pid, {I2, BlockSize, Data2}),
    ahoy_piece:add_completed_block(Pid, {I1, BlockSize, Data1}),
    % expect sorted data
